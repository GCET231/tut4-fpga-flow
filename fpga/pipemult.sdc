...
set_input_delay -clock vir_clock -max 2.0 [get_ports rdaddr*]
set_input_delay -clock vir_clock -min 1.5 [get_ports rdaddr*]
set_input_delay -clock vir_clock -max 2.0 [get_ports wraddr*]
set_input_delay -clock vir_clock -min 1.5 [get_ports wraddr*]
